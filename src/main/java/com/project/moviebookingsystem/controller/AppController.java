...
public class AppController {
	...
	@GetMapping("/register")
	public String showRegistrationForm(Model model) { // Model -> org.springframework.ui.Model -> adding attributes
		model.addAttribute("user", new User()); // User -> user model
		return "SignUpPage"; // any model attribute matches("user" => ${user}) -> will be filled with this
	}
